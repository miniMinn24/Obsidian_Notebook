...
> **BTLO (Blue Team Labs Online) Challenge**: https://blueteamlabs.online/home/challenge/network-analysis-web-shell-d4d3a2821b
...
ခုနက Packet က suspicious ဖြစ်ဖို့ကောင်းတာသေချာပေါက်ဆိုတော့ *Follow > TCP Stream*  ထောက်ပြီးဆက်ကြည့်ခဲ့ပါတယ်။ အဲ့ဒီမှာ plain text အဖြစ်နဲ့ fileToUpload ဆိုတဲ့ `dbfunctions.php` ဆိုတာကိုတွေရပါတယ်။
...
Payload အပြည့်အစုံကို *Follow > TCP*  မှာမြင်ရနိုင်ပါတယ်။
